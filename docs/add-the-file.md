...
3. Tap *Choose the file* and pick `BudgetLock-Assistant-v6.1.gguf`.
...
Put `BudgetLock-Assistant-v6.1.gguf` in the app's `models` folder.
...
| This isn't the assistant file. In Downloads, look for BudgetLock-Assistant-v6.1.gguf. | You picked a different file. Pick the one with that name. |
| This file is damaged or not version 6.1. Nothing was kept. Download it again. | The file is incomplete, altered, or an older version. Download it again. |
